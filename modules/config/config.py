...
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/SARKAROP123/SARKARVGTMUSIC",)
...
START_IMG_URL = getenv("START_IMG_URL", f"https://graph.org/file/7605e4861576cc8f74973.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "resource/ping")
